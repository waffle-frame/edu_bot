...
def register_admin_commands(dp: Dispatcher):
    ...
    dp.register_inline_handler(inline_echo, IDFilter(user_id=admin_ids))
    dp.register_chosen_inline_handler(get_similar_movies, IDFilter(user_id=admin_ids), state="*")
